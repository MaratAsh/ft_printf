...
/*   Updated: 2021/12/08 15:32:39 by alcierra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_putptr_upper(unsigned long long num)
{
	return (ft_putptr_upper_fd(num, 1));
}

int	ft_putptr_lower(unsigned long long num)
{
	return (ft_putptr_lower_fd(num, 1));
}