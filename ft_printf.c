...
/*   Updated: 2021/12/08 15:38:06 by alcierra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_make_rule(char *str, va_list argptr)
{
	...
	if (*str == 'c')
		...
		i += ft_putptr_lower((unsigned long long) va_arg(argptr, void *), 1);
	else if (*str == 'P')
		i += ft_putptr_upper((unsigned long long) va_arg(argptr, void *), 1);
	return (i);
}
